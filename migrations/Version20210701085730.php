 ...
 */
final class Version20210701085730 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE resume ADD niveau_liberte INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE resume DROP niveau_liberte');
    }
}
